...
while True:
    ...
    b1 = bus4.read_i2c_block_data(0x77, 0x88, 24)
    ...
    #		0x27(39)	Pressure and Temperature Oversampling rate = 1
    #					Normal mode
    bus4.write_byte_data(0x77, 0xF4, 0x27)
    # BMP280 address, 0x76(118)
    # Select Configuration register, 0xF5(245)
    #		0xA0(00)	Stand_by time = 1000 ms
    bus4.write_byte_data(0x77, 0xF5, 0xA0)
    ...
    # Pressure MSB, Pressure LSB, Pressure xLSB, Temperature MSB, Temperature LSB
    # Temperature xLSB, Humidity MSB, Humidity LSB
    data = bus4.read_i2c_block_data(0x77, 0xF7, 8)
    ...
    print("Temperature in Celsius :  C" + format(cTemp,'.2f'))
    print("Temperature in Fahrenheit :  F" + format(fTemp,'.2f'))
    print("Pressure : hPa " + format(pressure,'.2f') + "\n")
